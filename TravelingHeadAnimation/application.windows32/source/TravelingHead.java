...
public class TravelingHead extends PApplet {
...
public void thirdRaise() {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "TravelingHead" };
    if (passedArgs != null) {
